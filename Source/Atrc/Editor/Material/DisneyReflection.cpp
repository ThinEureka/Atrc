    ...
    : ResourceCommonImpl(creator)
{
    ...
    metallic_      .SetResourceChangedCallback(&IMaterial::Range01);
    subsurface_    .SetResourceChangedCallback(&IMaterial::Range01);
    specular_      .SetResourceChangedCallback(&IMaterial::Range01);
    specularTint_  .SetResourceChangedCallback(&IMaterial::Range01);
    roughness_     .SetResourceChangedCallback(&IMaterial::Range01);
    anisotropic_   .SetResourceChangedCallback(&IMaterial::Range01);
    sheen_         .SetResourceChangedCallback(&IMaterial::Range01);
    sheenTint_     .SetResourceChangedCallback(&IMaterial::Range01);
    clearcoat_     .SetResourceChangedCallback(&IMaterial::Range01);
    clearcoatGloss_.SetResourceChangedCallback(&IMaterial::Range01);
}
